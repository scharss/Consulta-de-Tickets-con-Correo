...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Consulta para obtener los pedidos del cliente y concatenar los tickets
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<div class="alert alert-warning" role="alert">No se encontraron tickets para el correo electrónico proporcionado.</div>';
    }
}
